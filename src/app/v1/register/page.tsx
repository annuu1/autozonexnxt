    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
      <Card style={{ width: 420 }}>
        ...
        <Form layout="vertical" onFinish={onFinish}>
          ...
          <Form.Item label="Password" name="password" rules={[{ required: true, message: "Please enter your password" }, { min: 8, message: "Minimum 8 characters" }]}>
        ...
        <Typography.Paragraph style={{ textAlign: "center", color: "#888", marginTop: 8 }}>
          Already have an account? <Link href={`/v1/login?from=${encodeURIComponent(from)}`}>Sign in</Link>
